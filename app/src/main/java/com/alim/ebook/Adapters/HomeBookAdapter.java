...
public class HomeBookAdapter extends RecyclerView.Adapter<HomeBookAdapter.mViewHolder> {

    private final Context mContext;
    private final ArrayList<Book> booksList;

    public HomeBookAdapter(Context mContext, ArrayList<Book> booksList) {
    ...
    static class mViewHolder extends RecyclerView.ViewHolder {
        ...
        mViewHolder(@NonNull View itemView) {
            ...
            thumbnail = itemView.findViewById(R.id.home_bookThumbnail);
            title = itemView.findViewById(R.id.home_bookTitle);
            author = itemView.findViewById(R.id.home_bookAuthor);
            row_parent = itemView.findViewById(R.id.home_parent_row_item);
            progressBar = itemView.findViewById(R.id.home_progressBar);
